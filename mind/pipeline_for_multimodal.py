...
if model_args.enable_label_token_requires_grad:
    modules_to_save += ['label_learner']
...
for k,v in model.named_parameters():
    ...
    #使modules_to_save中的参数requires_grad=True
    for target_module in modules_to_save:
...
logger.info(f"enable part of parameters requires grad, printing trainable params:")
